 ...
 */
export declare class ConfigManagement {
    private client;
    constructor();
    /**
     ...
     * @param useCase
     */
    createUseCaseConfig(useCase: UseCase): Promise<void>;
    /**
     * Method to update an existing SSM parameter for a deployed use case
     *
     * @param useCase
     */
    updateUseCaseConfig(useCase: UseCase, oldSSMParamName: string): Promise<void>;
    /**
     ...
     * @param useCase
     */
    deleteUseCaseConfig(useCase: UseCase): Promise<void>;
    /**
     * Method to retrieve an existing SSM parameter for a deployed use case
     */
    getUseCaseConfig(useCase: UseCase): Promise<void>;
    getUseCaseConfigFromName(configName: string): Promise<string>;
}
