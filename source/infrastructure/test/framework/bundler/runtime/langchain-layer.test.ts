    ...
    it('should generate the following commands for a local build', () => {
        ...
        expect(JSON.stringify(localBuild.bundle(stack, fakeModule, 'fake-output-dir'))).toBe(
            JSON.stringify([
                ...
                'poetry run pip install -r fake-output-dir/requirements.txt --python-version 3.13 --platform manylinux2014_x86_64 --implementation cp --only-binary=:all: -t fake-output-dir/python/',
