...
/**
 * JSON Schema for file upload requests via the POST /files REST API.
 */
export const filesUploadRequestSchema: JsonSchema = {
    ...
    properties: {
        fileNames: {
            ...
            minItems: 1,
            maxItems: MAX_FILE_UPLOADS_PER_BATCH,
            items: {
                type: JsonSchemaType.STRING,
                description: `Filename with supported extension (${SUPPORTED_MULTIMODAL_FILE_EXTENSIONS.join('|')})`,
