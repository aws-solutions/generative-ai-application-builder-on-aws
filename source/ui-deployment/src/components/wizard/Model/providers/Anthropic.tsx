...
export interface AnthropicModelProps extends BaseFormComponentProps {
    modelData: any;
}

export const AnthropicModel = (props: AnthropicModelProps) => {
    return (
        <SpaceBetween size="l" data-testid="anthropic-model-components">
