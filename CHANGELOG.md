...
- Bumped `uv` minimum version to `>=0.11.26` in container Dockerfiles to address a `quinn-proto` vulnerability ([RUSTSEC-2026-0185](https://rustsec.org/advisories/RUSTSEC-2026-0185.html)) shipped with `uv`
- Upgraded `joserfc` to `1.6.8` to mitigate [CVE-2026-48990](https://nvd.nist.gov/vuln/detail/CVE-2026-48990)

## [4.1.18] - 2026-06-29

### Security

- Upgraded `langsmith` to `0.9.2` to mitigate [GHSA-f4xh-w4cj-qxq8](https://github.com/advisories/GHSA-f4xh-w4cj-qxq8)
...
- Upgraded immutable to `5.1.5` to mitigate [CVE-2026-29063](https://nvd.nist.gov/vuln/detail/CVE-2026-29063)
- Upgraded joserfc to `1.6.3` to mitigate [CVE-2026-27932](https://nvd.nist.gov/vuln/detail/CVE-2026-27932)
...
- Upgraded urllib3 to `2.6.1` to mitigate CVE-2025-66418 and CVE-2025-66471.
